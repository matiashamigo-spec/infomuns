  ...
  app.post("/api/munsmood/process", munsmoodLimiter, async (req, res) => {
    ...
    try {
      ...
      const prompt =
        ...
        "CONTEXTO Y ANCLAJE FÍSICO: Analizá la foto antes de ubicar al personaje. Reglas de anclaje físico obligatorias:\n" +
        "- El personaje NUNCA flota en el aire. Siempre está apoyado en algo real: el piso, una superficie, el hombro de alguien, un mueble, etc.\n" +
        "- Si la foto es un plano medio o primer plano (no se ve el piso), el personaje se apoya sobre el hombro, el brazo, o se asoma desde un costado del encuadre — nunca aparece flotando en el fondo.\n" +
        "- La altura a la que aparece el personaje debe ser físicamente coherente: si está parado junto a la persona, sus pies deben estar al mismo nivel que los de la persona (o sobre la misma superficie).\n" +
        "- El personaje tiene perspectiva y profundidad coherente con la foto: si la persona está más lejos, el personaje (siendo más chico) parece estar en la misma distancia.\n" +
        "- El personaje interactúa con el entorno real: si hay una pared detrás, el personaje está delante de ella; si la persona está sentada, el personaje está parado en la misma superficie o sobre el asiento.\n\n" +
