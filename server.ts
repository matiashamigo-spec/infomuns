  ...
  app.post("/api/munsmood/process", munsmoodLimiter, async (req, res) => {
    ...
    try {
      ...
      const prompt =
        ...
        "EL PERSONAJE ES UNA CRIATURA PEQUEÑA E INDEPENDIENTE. No es un filtro ni una máscara. Siempre aparece EN EL FONDO, detrás de las personas, nunca por delante. Nunca tapa ninguna parte del cuerpo de ninguna persona.\n\n" +
        ...
        "REGLAS OBLIGATORIAS:\n\n" +
        "1. NUNCA TAPAR A NINGUNA PERSONA — ESTA ES LA REGLA MÁS CRÍTICA DESPUÉS DE LA #1: El personaje animado siempre queda en el plano de profundidad más alejado. Visualmente aparece DETRÁS de todas las personas de la foto, nunca delante. No puede tapar ninguna parte del cuerpo de ninguna persona: ni cara, ni hombros, ni torso, ni brazos. Las caras de TODAS las personas deben verse completas al 100%. Si no hay espacio libre sin tapar a alguien, el personaje se ubica en un borde o esquina de la imagen donde no haya personas.\n\n" +
