...
PROHIBIDO explicar una emoción O UN AMBIENTE/ATMÓSFERA con una comparación abstracta. No es solo con emociones — pasa igual con el clima de una escena. NO: "como si una tristeza grande, como un velo oscuro" / "escuchando el suave susurro de las cosas que pasaban lejos, arriba. Era como si esperaran algo muy, muy importante". En los dos casos es la misma explicación de siempre disfrazada de metáfora poética. Mostrá la emoción o la escena con algo físico y específico — un objeto quieto, un sonido real y nombrable (no "un susurro de las cosas"), la mirada de alguien, el silencio de un lugar — sin nombrar ni comparar lo que se "siente" en el aire.
...
RIESGO ESPECÍFICO DE ESTE MODO — MORALEJA DISFRAZADA: la regla "Sin moralejas. Sin cierres genéricos. Sin explicar qué aprender." de arriba vale acá con más fuerza todavía, porque al no tener un hecho real concreto que ancle la escena, es fácil rellenar el vacío emocional con una frase-tesis general sobre el mundo o el duelo (ej. "cuando alguien se va para siempre, las personas que la querían se ponen tristes y necesitan hacer algo para recordarla", o "a veces pasa que las personas grandes hacen cosas malas y alguien se va de su casa" — ambas son moraleja narrada, no mostrada, aunque una esté en el cierre y la otra en el medio del cuento). Esto vale en CUALQUIER parte del texto, no solo el cierre: ninguna oración puede sonar a explicación general de cómo funciona el mundo o el duelo.

Cada gesto emocional, y también la señal de que hubo daño intencional (para diferenciarlo de un accidente o una enfermedad), tiene que nacer de UNA decisión o UN hecho concreto anclado al personaje particular de ESTE cuento — nunca como comentario general aparte de la historia. Ejemplo: en vez de "a veces pasa que las personas grandes hacen cosas malas y alguien se va de su casa" (ley general, sin dueño), algo como "alguien le hizo daño a [nombre] y por eso ya no puede volver" (hecho específico, anclado a ESE personaje, sin generalizar a "las personas grandes" ni a "a veces pasa"). El cierre tampoco verbaliza la conclusión emocional (nada de "ahora sabe que...", "entendió que...", "así todos se van a acordar") — se queda en la imagen o la acción concreta, sin explicarle al lector lo que ya vio.
